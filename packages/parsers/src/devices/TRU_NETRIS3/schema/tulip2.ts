...
import type { TRUTulip2Channels, TRUTulip2FeatureFlags } from '../parser/tulip2/constants'
...
export type TRUTULIP2ConfigurationAction = TULIP2ConfigurationAction<TRUTulip2Channels[number], TRUTulip2FeatureFlags>
