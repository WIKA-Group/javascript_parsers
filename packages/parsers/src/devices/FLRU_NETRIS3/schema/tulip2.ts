...
import type { FLRUTulip2Channels, FLRUTulip2FeatureFlags } from '../parser/tulip2/constants'
...
export type FLRUTULIP2ConfigurationAction = TULIP2ConfigurationAction<FLRUTulip2Channels[number], FLRUTulip2FeatureFlags>
