...
If the documentation refers to percentage values, use the real-world values (e.g. 20% deadband with 0-1000 mm range is 200 mm).

To understand the input structure, refer to the [downlink examples](https://github.com/WIKA-Group/javascript_parsers/blob/main/packages/parsers/src/devices/FLRU_NETRIS3/examples.json).
