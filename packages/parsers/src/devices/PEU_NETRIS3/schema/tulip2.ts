...
import type { PEUTulip2Channels, PEUTulip2FeatureFlags } from '../parser/tulip2/constants'
...
import {
  ...
  TECHNICAL_CAUSE_OF_FAILURE_NAMES,
  ...
  return createUplinkSchema({
    ...
    extension: {
      deviceInformation: v.object({
        ...
        productSubId: v.picklist(Object.values(PRODUCT_SUB_ID_NAMES) as (typeof PRODUCT_SUB_ID_NAMES)[keyof typeof PRODUCT_SUB_ID_NAMES][]),
...
export type PEUTULIP2ConfigurationAction = TULIP2ConfigurationAction<PEUTulip2Channels[number], PEUTulip2FeatureFlags>
