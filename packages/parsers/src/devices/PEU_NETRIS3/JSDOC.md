# PEU + Netris3 Parser Quick Start
...
To understand the input structure, refer to the [downlink examples](https://github.com/WIKA-Group/javascript_parsers/blob/main/packages/parsers/src/devices/PEU_NETRIS3/examples.json).
...
Both channels on the PEU are **configurable**. You must verify the actual measurement ranges from your device specifications or identification frames. The parser defaults shown in the table above may not match your device configuration.
