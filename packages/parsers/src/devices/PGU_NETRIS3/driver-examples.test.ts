...
import { createPGUUplinkOutputSchema } from './schema'
...
describe('pGU+NETRIS3 parser', () => {
  ...
  const outputSchema = createPGUUplinkOutputSchema()
...
describe('pGU+NETRIS3 parser range lifecycle', () => {
