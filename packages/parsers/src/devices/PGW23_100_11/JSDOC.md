...
2. Add configuration code below at the bottom of your parser file2. If your LNS (LoRaWAN Network Server) is compatible you need to wrap the code in a global function:
```javascript
