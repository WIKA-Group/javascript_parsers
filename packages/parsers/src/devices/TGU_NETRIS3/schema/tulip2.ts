...
import { TGUTULIP2_DEVICE_TEMPERATURE_CHANNEL, TGUTULIP2_TEMPERATURE_CHANNEL } from '../parser/tulip2/channels'
import { ALARM_EVENTS, DEVICE_ALARM_STATUS_TYPES, LPP_MEASURANDS_TEMPERATURE, LPP_UNITS_TEMPERATURE, PROCESS_ALARM_TYPES, TECHNICAL_ALARM_TYPES, TECHNICAL_CAUSE_OF_FAILURE_NAMES } from '../parser/tulip2/lookups'

const createUplinkSchema = createUplinkOutputSchemaFactory(31)

// Temperature channel typed arrays (used for both channels)
...
const temperatureChannelSchema = v.object({
  channelId: v.literal(TGUTULIP2_TEMPERATURE_CHANNEL.channelId),
  channelName: v.literal(TGUTULIP2_TEMPERATURE_CHANNEL.name),
  value: v.number(),
})

const deviceTemperatureChannelSchema = v.object({
  channelId: v.literal(TGUTULIP2_DEVICE_TEMPERATURE_CHANNEL.channelId),
  channelName: v.literal(TGUTULIP2_DEVICE_TEMPERATURE_CHANNEL.name),
  value: v.number(),
})
    ...
    extension: {
      measurement: v.object({
        channels: v.array(v.union([
          temperatureChannelSchema,
          deviceTemperatureChannelSchema,
        ])),
      }),
    },
  })
...
function createDeviceTemperatureChannelConfigurationSchema() {
  return v.object({
    channelId: v.literal(TGUTULIP2_DEVICE_TEMPERATURE_CHANNEL.channelId),
    channelName: v.literal(TGUTULIP2_DEVICE_TEMPERATURE_CHANNEL.name),
    measurand: v.picklist(TEMPERATURE_MEASURAND_IDS),
    ...
    extension: {
      deviceInformation: v.object({
        ...
        channelConfigurations: v.tuple([
          ...
          createDeviceTemperatureChannelConfigurationSchema(),
        ]),
      }),
    },
  })
...
export function createTGUTULIP2UplinkOutputSchema() {
  return v.union([
...
export type TGUTULIP2DataMessageData = v.InferOutput<ReturnType<typeof createDataMessageUplinkOutputSchema>>['data']['measurement']
export type TGUTULIP2DataMessageUplinkOutput = v.InferOutput<ReturnType<typeof createDataMessageUplinkOutputSchema>>

export type TGUTULIP2ProcessAlarmsData = v.InferOutput<ReturnType<typeof createProcessAlarmsUplinkOutputSchema>>['data']['processAlarms']
export type TGUTULIP2ProcessAlarmsUplinkOutput = v.InferOutput<ReturnType<typeof createProcessAlarmsUplinkOutputSchema>>

export type TGUTULIP2TechnicalAlarmsData = v.InferOutput<ReturnType<typeof createTechnicalAlarmsUplinkOutputSchema>>['data']['technicalAlarms']
export type TGUTULIP2TechnicalAlarmsUplinkOutput = v.InferOutput<ReturnType<typeof createTechnicalAlarmsUplinkOutputSchema>>

export type TGUTULIP2DeviceAlarmsData = v.InferOutput<ReturnType<typeof createDeviceAlarmsUplinkOutputSchema>>['data']['deviceAlarm']
export type TGUTULIP2DeviceAlarmsUplinkOutput = v.InferOutput<ReturnType<typeof createDeviceAlarmsUplinkOutputSchema>>

export type TGUTULIP2DeviceInformationData = v.InferOutput<ReturnType<typeof createDeviceInformationUplinkOutputSchema>>['data']['deviceInformation']
export type TGUTULIP2DeviceInformationUplinkOutput = v.InferOutput<ReturnType<typeof createDeviceInformationUplinkOutputSchema>>

export type TGUTULIP2DeviceStatisticsData = v.InferOutput<ReturnType<typeof createDeviceStatisticsUplinkOutputSchema>>['data']['deviceStatistic']
export type TGUTULIP2DeviceStatisticsUplinkOutput = v.InferOutput<ReturnType<typeof createDeviceStatisticsUplinkOutputSchema>>
