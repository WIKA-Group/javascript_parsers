...
To understand the input structure, refer to the [downlink examples](https://github.com/WIKA-Group/javascript_parsers/blob/main/packages/parsers/src/devices/TGU_NETRIS3/examples.json).
