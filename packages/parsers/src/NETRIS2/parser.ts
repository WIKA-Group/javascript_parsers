import type {
  ...
  BaseMessage,
  ChannelMeasurement,
  DownlinkOutputSuccessful,
  OutputError,
  OutputFailure,
  OutputWarning,
  UplinkInput as UInput,
} from '../shared'
...
const TECHNICAL_ALARM_CAUSE_OF_FAILURE_NAMES_DICTIONARY = [
  'no alarm',
  'open condition',
  'short condition',
  'saturated low',
...
export type UplinkInput = UInput

export type UplinkOutput = UplinkOutputSuccessful | OutputFailure
...
interface DownlinkInputSetMeasureOffsetConfiguration {
  ...
  configuration: {
    channel0?: { measureOffset: Offset }
    channel1?: { measureOffset: Offset }
  }
}
